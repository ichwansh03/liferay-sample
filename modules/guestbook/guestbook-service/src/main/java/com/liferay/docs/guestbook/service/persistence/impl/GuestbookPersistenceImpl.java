...
public class GuestbookPersistenceImpl
	...
	private FinderPath _finderPathWithPaginationFindByEntry;
	private FinderPath _finderPathWithoutPaginationFindByEntry;
	private FinderPath _finderPathCountByEntry;
	 ...
	 */
	@Override
	public List<Guestbook> findByEntry(long groupId) {
		return findByEntry(groupId, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}
	 ...
	 */
	@Override
	public List<Guestbook> findByEntry(long groupId, int start, int end) {
		return findByEntry(groupId, start, end, null);
	}
	 ...
	 */
	@Override
	public List<Guestbook> findByEntry(
		long groupId, int start, int end,
		OrderByComparator<Guestbook> orderByComparator) {

		return findByEntry(groupId, start, end, orderByComparator, true);
	}
	...
	public List<Guestbook> findByEntry(
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
			...
			if (useFinderCache) {
				finderPath = _finderPathWithoutPaginationFindByEntry;
				finderArgs = new Object[] {groupId};
			}
		}
		else if (useFinderCache) {
			finderPath = _finderPathWithPaginationFindByEntry;
		...
		if (list == null) {
			...
			sb.append(_FINDER_COLUMN_ENTRY_GROUPID_2);
	...
	public Guestbook findByEntry_First(
		...
		Guestbook guestbook = fetchByEntry_First(groupId, orderByComparator);
	...
	public Guestbook fetchByEntry_First(
		...
		List<Guestbook> list = findByEntry(groupId, 0, 1, orderByComparator);
	...
	public Guestbook findByEntry_Last(
		...
		Guestbook guestbook = fetchByEntry_Last(groupId, orderByComparator);
	...
	public Guestbook fetchByEntry_Last(
		...
		int count = countByEntry(groupId);

		if (count == 0) {
			return null;
		}

		List<Guestbook> list = findByEntry(
	...
	public Guestbook[] findByEntry_PrevAndNext(
		...
		try {
			...
			array[0] = getByEntry_PrevAndNext(
				session, guestbook, groupId, orderByComparator, true);

			array[1] = guestbook;

			array[2] = getByEntry_PrevAndNext(
	...
	protected Guestbook getByEntry_PrevAndNext(
	...
	public int countByEntry(long groupId) {
		FinderPath finderPath = _finderPathCountByEntry;
	...
	private static final String _FINDER_COLUMN_ENTRY_GROUPID_2 =
		"guestbook.groupId = ?";
	...
	public void activate(BundleContext bundleContext) {
		...
		_finderPathWithPaginationFindByEntry = _createFinderPath(
		...
		_finderPathWithoutPaginationFindByEntry = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByEntry",
			new String[] {Long.class.getName()}, new String[] {"groupId"},
			true);

		_finderPathCountByEntry = _createFinderPath(
